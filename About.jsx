    ...
    <div className="px-5 sm:px-10">
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          ...
          <p>
            Prescripto is committed to excellence in healthcare technology. With the latest advancements to improve user
            experience and deliver superior service, Prescripto is here to support you every step of the way.
          </p>
          <b className="text-gray-800">Our Vision</b>
          <p>
            Our vision at Prescripto is to create a seamless healthcare experience for every user. We aim to bridge the
            gap between patients and healthcare providers, making it easier for you to access the care you need when you
            need it.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-20">
        <div
          className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-3 text-[15px] hover:text-white hover:bg-gray-700 
